...
class SimpleJump {
    ...
    constructor() {
        ...
        this.obstacle = Matter.Bodies.rectangle(width / 2, height - 70, 20, 100, {
            isStatic: true,
            friction: 1,
            collisionFilter: {
                category: BOUNDARY_COLLISION_GROUP
     ...
     */
    add_to_world() {
        Matter.World.add(world, [this.ground, this.roof, this.left_wall, this.right_wall, this.obstacle]);
    }
